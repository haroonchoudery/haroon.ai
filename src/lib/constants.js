...
export const PROFILES = {
  twitter: {
    title: 'Twitter',
    username: 'haroonchoudery',
    url: 'https://twitter.com/intent/user?screen_name=haroonchoudery',
    icon: <TwitterIcon size={16} />
  },
  // github: {
  //   title: 'GitHub',
  //   url: 'https://github.com/haroonchoudery',
  //   icon: <GithubIcon size={16} />
  // },
  linkedin: {
    title: 'LinkedIn',
    url: 'https://www.linkedin.com/in/haroonchoudery/',
  ...
  // instagram: {
  //   title: 'Instagram',
  //   url: 'https://www.instagram.com/haroonchoudery',
